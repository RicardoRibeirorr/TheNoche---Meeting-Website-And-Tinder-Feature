<template>
  <div class="sc-message">
    <div class="sc-message--content" :class="{
        sent: message.author.name === 'me',
        received: message.author.name !== 'me' && message.type !== 'system',
      ...
      <slot 
        ...
        :message="message" 
        :user="user">
          <div v-if="message.type !== 'system' || message.author.name!== 'me'" :title="authorName" class="sc-message--avatar" :style="{
...
export default {
  ...
  methods: {
    ...
    determineMessageColors() {
      return this.message.author.name === 'me' ? this.sentColorsStyle() : this.receivedColorsStyle()
    }
  },
  computed:{
    authorName(){
