    ...
    <form class="sc-user-input" :class="{active: inputActive}" :style="{background: colors.userInput.bg}">
      ...
      <div class="sc-user-input--buttons">
        ...
        <div class="sc-user-input--button">
          <user-input-button @click.native.prevent="_submitText" :color="colors.userInput.text" tooltip="Send">
            <icon-send />
          </user-input-button>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    _submitText (event) {
      ...
      if (file) {
        this._submitTextWhenFile(event, text,  window.URL.createObjectURL(file))
      } else {
